 ...
 */
    ...
    public function __construct($getWSDL = false, $debug = false, $params = null)
    {
        ...
        if ($this->config) {
            ...
            $this->baseAuthUrl = $this->config["baseAuthUrl"];
            if (array_key_exists('xmlloc', $this->config)) {
                $this->xmlLoc = $this->config['xmlloc'];
            }

            if (array_key_exists('proxyhost', $this->config)) {
                $this->proxyHost = $this->config['proxyhost'];
            }
            if (array_key_exists('proxyport', $this->config)) {
                $this->proxyPort = $this->config['proxyport'];
            }
            if (array_key_exists('proxyusername', $this->config)) {
                $this->proxyUserName = $this->config['proxyusername'];
            }
            if (array_key_exists('proxypassword', $this->config)) {
        ...
        if ($params) {
            ...
            if ($params && array_key_exists('proxyusername', $params)) {
